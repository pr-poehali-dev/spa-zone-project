...
export const PROGRAMS = [
  ...
  {
    title: "Ладование — только для двоих в банном комплексе",
    subtitle: "Такой формат особенно подходит для пар, выбирающих спокойный совместный отдых. Ваш пар-мастер учитывает интересы обеих гостей.",
    tag: "Для семьи",
