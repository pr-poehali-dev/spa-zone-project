...
const MARQUEE_ITEMS = [
  "Бассейн", "Финская сауна", "Хамам", "Массаж", "Пространство пара",
...
const SPACES = [
  ...
  { icon: "Sparkles", title: "СПА — Косметика, которая работает глубже, чем вы думаете", desc: "Косметические процедуры, обёртывания и уходовые ритуалы для кожи с профессиональной косметикой.\n\nВ Пространстве Пара мы используем только профессиональную космецевтику — Комфорт Зон и Талассо Бретань. Талассо Бретань создана на основе морских водорослей и минералов атлантического побережья Франции — они насыщают кожу йодом, магнием и цинком, запуская процессы естественного восстановления на клеточном уровне. Обёртывания и скрабирование с морскими компонентами выводят токсины, разглаживают кожу и активируют лимфодренаж — тело буквально становится легче. Комфорт Зон — итальянская космецевтика с доказанным действием: активные концентраты глубоко питают, восстанавливают барьер кожи и замедляют процессы старения. В сочетании с теплом парной и хаммама косметика проникает в 3–4 раза глубже, чем при обычном нанесении. Результат виден уже после первой процедуры: кожа мягкая, упругая, насыщенная — как после моря. Это не уход ради ухода — это инвестиция в своё тело.", tag: "Красота", img: "https://cdn.poehali.dev/projects/96829bf9-8ea6-42db-bc21-6a2d363e218e/bucket/21f81724-a20a-4ce9-a0d4-d093b4801c05.jpg", imgs: ["https://cdn.poehali.dev/projects/96829bf9-8ea6-42db-bc21-6a2d363e218e/bucket/21f81724-a20a-4ce9-a0d4-d093b4801c05.jpg", "https://cdn.poehali.dev/projects/96829bf9-8ea6-42db-bc21-6a2d363e218e/bucket/6284b1da-37e5-49a7-884b-955656d70c38.jpg", "https://cdn.poehali.dev/files/7b99a33b-4d26-4682-9186-109c55f0f264.jpg"] },
];
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p style={{ color: "#8B7355", lineHeight: 1.8, marginBottom: 32, fontSize: 15 }}>
