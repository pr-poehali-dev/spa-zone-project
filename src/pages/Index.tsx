...
const SPACES = [
  ...
  { icon: "Sparkles", title: "Beauty-зона", desc: "Косметические процедуры, обёртывания и уходовые ритуалы для кожи с профессиональной косметикой.", tag: "Красота", img: "https://cdn.poehali.dev/projects/96829bf9-8ea6-42db-bc21-6a2d363e218e/bucket/21f81724-a20a-4ce9-a0d4-d093b4801c05.jpg" },
];
