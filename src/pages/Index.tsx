...
const SPACES = [
  ...
  { icon: "Trees", title: "Можжевеловая комната", desc: "Ароматная комната с можжевеловыми досками и эфирными маслами — природное восстановление дыхания.", tag: "Можжевеловая комната", img: SAUNA_IMAGE, imgs: ["https://cdn.poehali.dev/files/ca1bd218-a636-47d0-9274-451e54c2cd18.jpg", "https://cdn.poehali.dev/files/2eced06b-a37e-48f8-a7b3-3443680ee5e1.jpg"] },
