...
const PROMOS = [
  ...
  {
    title: "Медовый массаж — кожа как шёлк",
    desc: "Тёплый мёд наносится на всё тело и мягко вытягивает токсины. После первой процедуры кожа заметно мягче, ровнее — и наполнена теплом изнутри.",
    img: "https://cdn.poehali.dev/projects/96829bf9-8ea6-42db-bc21-6a2d363e218e/bucket/60e9b2fe-5f59-488b-9300-3b4633dd4edb.jpg",
  },
];
